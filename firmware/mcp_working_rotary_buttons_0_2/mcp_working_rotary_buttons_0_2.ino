...
int encSelect[3] = {
  101, 0}; // stores the last encoder used and direction {encNo, 1=CW or 2=CCW}
...
const int encPins0[encCount0][2] = {
  {
    9,10  }
  ,   // enc:0 AA GPA0,GPA1 - pins 21/22 on MCP23017
  {
    11,12  }
  ,
  {
    13,14  }  // enc:1 BB GPA3,GPA4 - pins 24/25 on MCP23017
};  
